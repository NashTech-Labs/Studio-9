...
object Settings {
  ...
  lazy val buildSettings = Seq(
    ...
    description := """Job Master Services""",
    organizationHomepage := Some(url("https://www.deepcortex.ai")),
    scalaVersion := Versions.ScalaVersion,
    homepage := Some(url("https://github.com/deepcortex/cortex-job-master")),
  ...
  lazy val buildInfoSettings = Seq(
      ...
      buildInfoPackage := "cortex.jobmaster.common",
