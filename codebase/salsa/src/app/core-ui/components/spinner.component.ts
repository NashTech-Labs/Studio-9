...
@Component({
  ...
  template: `<div *ngIf="visibility" class="spinner-wrapper">
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" [ngStyle]="{'margin-top': -height/2 + 'px', 'margin-left': -height/2 + 'px'}"
      x="0px" y="0px" [attr.width]="height + 'px'" [attr.height]="height + 'px'"
...
export class SpinnerComponent {
  ...
  @Input() color: string = '#0d47a1';
  @Input() backgroundColor: string = '#0d47a1';
