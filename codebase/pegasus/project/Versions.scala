object Versions {
  ...
  val FabricatorTestVersion       = "2.1.4"
  val ScalaMockVersion            = "3.6.0"
  val ScalaMeterVersion           = "0.8.2"

  val SlickVersion                = "3.2.0"
  val RedshiftJdbcVersion         = "1.2.10.1009"
  val AwsSdkVersion               = "1.11.106"
  val OrionIpcVersion             = "0.1.23"
  val CortexGRPCVersion           = "v0.0.39.3-SNAPSHOT"
}
