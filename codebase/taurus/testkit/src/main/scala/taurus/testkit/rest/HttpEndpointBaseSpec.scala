...
import taurus.common.service.DateImplicits
...
trait HttpEndpointBaseSpec extends WordSpecLike with Matchers with ScalatestRouteTest with CustomEqualities with DateImplicits { self =>
