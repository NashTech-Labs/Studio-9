...
object Dependencies {
  ...
  object Compile {
    ...
    val akkaPersistenceMongo    = "com.github.scullxbones"        %% "akka-persistence-mongo-casbah"      % AkkaPersistenceMongoVersion
    ...
    val amazonAws               = "com.amazonaws"                 %  "aws-java-sdk"                       % AmazonAwsVersion
  ...
  val akkaPersistence   = Seq(Compile.akkaPersistence, Compile.casbah, Compile.akkaPersistenceMongo)
  ...
  val amazon            = Seq(Compile.amazonAws, Compile.awsScala)
  val grpc              = Seq(Compile.cortexGRPC)
  ...
  lazy val common = shared ++ akkaHttp ++ json4sJson ++ orionRpc ++ Seq(Test.scalaTest % "test") ++ amazon ++ grpc

  lazy val taurusApiService = shared ++ akka ++ orionRpc ++ akkaPersistence

  lazy val taurusApiRest = shared ++ akkaHttp
}
