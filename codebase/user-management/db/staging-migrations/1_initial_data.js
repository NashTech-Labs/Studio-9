...
exports.migrate = function(client, done) {
    ...
    users.insertMany([{
        ...
        "username": "root",
        "email" : "no_such_user@deepcortex.ai",
        ...
        "password" : "2710:39hcvxzVTRYPGBjU8eG48AbLXT3ubZG7:NuJPlNq+jPc8wlsWgiay6VCac1jmRSr8",
        "firstName" : "DeepCortex",
        "lastName" : "User",
        "status" : "ACTIVE",
        "groupIds": ["groups_read_only_um"],
        "dataFilterInstances": [],
        "organizationId": "orgs_sentrana",
        "created": "2016-05-06T00:00:00.000Z",
        "updated": "2016-05-06T00:00:00.000Z"
    }])
    ...
    applications.insertMany([{
        ...
        "name": "DeepCortex",
        "desc": "DeepCortex",
        "url": "https://staging.deepcortex.ai",
        "passwordResetUrl": "https://staging.deepcortex.ai/signin/password/complete",
