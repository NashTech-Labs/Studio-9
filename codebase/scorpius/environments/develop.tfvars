...
# the VPC CIDR block you will launch knoldususa into
...
# the VPC ID of the VPC you will launch knoldususa into
vpc_id                          = "vpc-a7d785c1"

# the VPC S3 Endpoint of the VPC you will launch knoldususa into
vpce_id                         = "vpce-a45a91cd"

# the subnet IDs of the subnets you will launch knoldususa into
...
bastion_ami_id                  = "ami-045c6a49807585f97"

# the ami id for the machines that will run knoldususa (should be a CentOS/RHEL 7.4 ami)
packer_base_ami                 = "ami-045c6a49807585f97"
...
# operating system for knoldususa machines (centos or rhel)
machine_os                      = "rhel"
...
# the public ssh key for the key you would like to use to access the DC/OS machines used for knoldususa
ssh_public_key                  = ""
...
# the CIDR for a VPN or machine IP that should be able to access knoldususa
access_cidr                     = "122.177.196.145/32"
...
deploy_cidr                     = "122.177.196.145/32"
...
ssh_keys_s3_bucket              = "artifacts.dev.knoldususa.com/configurations/ssh/keys.public"

# path of license key present in S3
#license_keys_s3_bucket          = "artifacts.dev.knoldususa.ai/configurations/dcos-license/license.txt"

# path of vulkan filesystem for gpu node in case of public deployment
vulkan_file_path               = "knoldususa-dcos-artifacts/configurations/packages/vulkan-filesystem-1.1.73.0-1.el7.noarch.rpm"
...
# if you would like to restore mongo data from a backup, provide the date (YYYY_MM_DD) which should correspond to a directory in the main knoldususa S3 bucket under mongo_backups
mongo_restore_date              = ""
...
artifacts_s3_bucket             = "knoldususa-dcos-artifacts"

######################################################

#################### S3 Buckets ######################

# the name of the S3 buckets used for storing terraform artifacts, storing knoldususa data, and storing DC/OS data
tf_bucket                       = "knoldususa-develop-terraform"
dcos_apps_bucket                = "knoldususa-develop-dcos-apps"
dcos_stack_bucket               = "knoldususa-develop-dcos-backend"
...
# specify if Public MSTAR and CAD data should be uploaded to the default knoldususa S3 bucket
...
# Platform
s3_prefix                       = "knoldususa"
cluster_name                    = "knoldususa-develop"
...
redshift_master_username = "knoldususa"
...
# Docker
docker_registry_url = "cloud.canister.io:5000"

### Application Versions

# core applications

aries_docker_image_version = "1.0"
baile_docker_image_version = "1.0"
cortex_docker_image_version = "1.0"
cortex_task_docker_image_version = "1.0"
orion_docker_image_version = "1.0"
job_master_docker_image_version = "1.0"
um_docker_image_version = "1.0"
jupyter_lab_docker_image_version = "1.0"
gemini_docker_image_version = "1.0"
sql_server_docker_image_version = "1.0"


# supporting services

baile_haproxy_docker_image_version = "1.0"
logstash_docker_image_version = "1.0"
rmq_docker_image_version = "1.0"
...
docker_tar_list = "aries-api-rest.tar,baile-haproxy.tar,baile.tar,cortex-api-rest.tar,cortex-job-master.tar,cortex-tasks-gpu.tar,cortex-tasks-sklearn.tar,dcos-rabbitmq.tar,orion-api-rest.tar,um-service.tar,gemini.tar,cortex-tasks-jupyterlab.tar,sql-server.tar,logstash-rmq.tar"
######################################################
