...
ssh_key_name                    = "deepcortex-master-dev"
...
ssh_keys_s3_bucket              = "artifacts.dev.gov.deepcortex.ai/configurations/ssh/keys.public"

license_keys_s3_bucket          = "artifacts.dev.gov.deepcortex.ai/configurations/dcos-license/license.txt"
...
artifacts_s3_bucket             = "falcon-scorpius-assets-mda-prep-auto-gov"
...
tf_bucket                       = "falcon-deepcortex-autogov-terraform"
dcos_apps_bucket                = "falcon-deepcortex-autogov-dcos-apps"
dcos_stack_bucket               = "falcon-deepcortex-autogov-dcos-backend"
...
cluster_name                    = "deepcortex-autogov"
...
gpu_jupiter_asg_desired_capacity  = "0"
gpu_jupiter_asg_min_size          = "0"
gpu_jupiter_asg_max_size          = "1"

# mesos, docker, log
gpu_jupiter_xvde_size             = "50"
gpu_jupiter_xvdf_size             = "50"
gpu_jupiter_xvdh_size             = "50"
...
# dremio, log
master_coordinator_xvde_size       = "50"
master_coordinator_xvdf_size       = "20"

#dremio, log
executor_xvde_size                 = "150"
executor_xvdf_size                 = "100"

include_dremio                     = "true"

# true or false depending upon dremio cluster is single node or multi-node
single_node_dremio_cluster         = "true"

master_coordinator_asg_desired_capacity = "1"
master_coordinator_asg_min_size         = "1"
master_coordinator_asg_max_size         = "1"

executor_asg_desired_capacity           = "2"
executor_asg_min_size                   = "1"
executor_asg_max_size                   = "2"

# if you would like to restore dremio data from a backup, provide the date (YYYY_MM_DD) which should correspond to a directory in the main DeepCortex S3 bucket under dremio_backups
dremio_restore_date              = ""

# the number of days you wish to store dremio backups
dremio_backup_retention_period = "7"
...
aries_docker_image_version = "2.1.0-20-g4c7fcc7"
baile_docker_image_version = "2.1.5-1119-ga5253b0"
cortex_docker_image_version = "2.1.0-22-g33b555e"
cortex_task_docker_image_version = "e79dd5a"
orion_docker_image_version = "2.1.0-68-gb3d6589"
job_master_docker_image_version = "2.1.4-329-g8470984"
um_docker_image_version = "2.0.0"
jupyter_lab_docker_image_version = "e79dd5a"
gemini_docker_image_version = "0.0.0-b8b80b28c7ec3a6c2bc2af9ba02d8b3a76c5bd43"
sql_server_docker_image_version = "0.1"
